...
func update_animation_parameters():
	if (velocity == Vector3.ZERO):
		animation_tree["parameters/idleWalk/blend_amount"] = 0.0
		...
		animation_tree["parameters/idleWalk/blend_amount"] = min(1.0, velocity.length())
	...
	if (is_running):
		animation_tree["parameters/walkRun/blend_amount"] = 1.0
	else:
		animation_tree["parameters/walkRun/blend_amount"] = 0.0
